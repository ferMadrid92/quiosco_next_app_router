    ...
    <nav className="flex justify-center py-10">
        ...
        {pages.map(currentPage => (
            <Link
                ...
                className={`${page === currentPage ? ' text-white font-black bg-black ' : 'bg-white' }  px-4 py-2 text-sm text-gray-900 ring-1 ring-inset ring-gray-300 focus:z-20 focus:outline-offset-9`}
            >{currentPage}</Link>
        ))}
